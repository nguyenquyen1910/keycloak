...
public class ErrorNormalizer {
    ...
    public ErrorNormalizer(ObjectMapper objectMapper) {
        ...
        errorCodeMap.put("User exists with same username", ErrorCode.USERNAME_EXISTS);
    ...
    public AppException handleKeyCloakExeption(FeignException exception) {
        try {
            ...
            log.error("Error parsing KeyCloak error", exception);
        }
